    ...
    <div class="logo" data-tauri-drag-region>
      ...
      <div class="api-pro">
        <el-progress
          :text-inside="true"
          :stroke-width="20"
          :percentage="userStore.apiRate"
          :color="colors"
          status="exception"
        >
          <el-tooltip
            class="box-item"
            :content="`每小时可发送5000个请求, 已使用：${
              userStore.apiLimit.used
            }, 剩余：${
              userStore.apiLimit.remaining
            } 恢复时间：${timestampToTime(userStore.apiLimit.reset)}`"
            placement="right"
          >
      ...
      <div class="user-info">
        <el-dropdown trigger="click">
          <img
            ...
            onerror="this.src='https://jsd.cdn.zzko.cn/gh/Sjj1024/FileHub@main/root/Filehub/128x128.png'"
            alt=""
            class="user-img"
          />
          <template #dropdown>
